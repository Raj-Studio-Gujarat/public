          ...
          <Container>
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {section.packages.map((pkg, pkgIndex) => (
                <Reveal key={pkg.frame} delay={pkgIndex * REVEAL_STAGGER}>
                  <article className="flex h-full flex-col border border-line bg-background p-6 transition-colors duration-200 hover:border-ink">
